$(function () {
    ...
    function init (browserVersions) {
        ...
        function getLatestBrowsers (cb) {
            $.get('https://www.browserling.com/browsers.json', function (data) {
                try {
    ...
    // make footer www.browserling.com clickable
    $('#footer a').click(function (ev) {
        ev.preventDefault();

        var newUrl = "https://www.browserling.com";
        createTab(newUrl);
    });
    ...
    $('#run input').click(function () {
        ...
        if (platform_name == 'android') {
            var newUrl = "https://www.browserling.com/browse/" + 
                platform_name + '/' +
                platform_version + '/' +
